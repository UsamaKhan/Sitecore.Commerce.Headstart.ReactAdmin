# Sitecore Commerce Headstart: NextJS Admin Dashboard
...
## What is Sitecore Commerce Dashboard?

A **simple**, **powerful** and **flexible** Commerce Seller Application built on top of Sitecore [OrderCloud API](https://ordercloud.io/api-reference) and the [OrderCloud Javascript SDK](https://www.npmjs.com/package/ordercloud-javascript-sdk) built with:
...
- Create, read, update, and delete product catalogs and categories
- Create, read, update, and delete products with Extended propreties
- Create, read, update, and delete promotions
- Create, read, update, and delete buyers
- Create, read, update, and delete user groups and users
